...
P = Problema(12, 12, t=0.10)
esc = P.escenario(seed=0)
print(f"Instancia 12x12: nV={P.nV} nA={P.nA} cuota={list(P.quota)}", file=sys.stderr)
...
print(f"\nTiempo total barrido 12x12: {dt:.1f}s", file=sys.stderr)
...
with open("resultados/milp_12x12.json", "w") as fh:
    json.dump(out, fh, indent=2)
print("guardado en resultados/milp_12x12.json", file=sys.stderr)
