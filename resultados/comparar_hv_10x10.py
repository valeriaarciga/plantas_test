...
with open("resultados/milp_10x10.json") as fh:
...
res, hv_hist, gen_conv = correr_nsga2(P, esc, pop=120, gens=200, seed=0, ref_point=(300.0, 80.0))
...
print(f"Instancia 10x10 (nV={P.nV}, nA={P.nA}), escenario seed=0, ref_point={ref}")
...
resumen = {
    "instancia": "10x10", "nV": P.nV, "nA": P.nA, "ref_point": ref,
...
with open("resultados/comparacion_hv_10x10.json", "w") as fh:
